...
--------------VARIABLEN------------------------
-----------------------------------------------
declare @code nvarchar(255)               = 'fi_clarity_adb1_m9_clusters_categories'
declare @revision nvarchar(255)           = '20250903'
declare @name nvarchar(255)               = 'Fileimport clarity_m9_clusters_categories'
declare @description nvarchar(max)        = 'Fileimport of genaico_adb1.m9_clusters_categories from clarity adb1'

declare @directory nvarchar(255)          = 'c:\mountpoints\gpfs\import\access\clarity\m9_clusters_categories\v1'
declare @files nvarchar(255)              = 'm9_clusters_categories_20%.csv'


declare @mode_id smallint                 = import.get_latest_mode()   --import.get_latest_mode, import.get_once_mode(), import.get_always_mode()

declare @sl_db nvarchar(255)              = 'access'
declare @sl_schema nvarchar(255)          = 'sl_genaico_adb1'
declare @sl_tablename nvarchar(255)       = 'm9_clusters_categories'
...
declare @ods_tablename nvarchar(255)      = 'm9_clusters_categories'
...
declare @sl_load_delta nchar(1)           = 'F'   --I=Inkrementell, d.h. nur Insert und Update werden gemerged, F=Full auch Deletes werden gemerged   --'F' for full oder 'I' for incremental 
...
values
  ( 1,   0,     'version_id',									'int',					null,        @coldelim,  0,         null,   'NULL',  null,  null,   0,               0 )
 ,( 2,   0,     'category_data',								'nvarchar(max)',	    null,        @coldelim,  0,         null,   'NULL',  null,  null,   0,               0 )
